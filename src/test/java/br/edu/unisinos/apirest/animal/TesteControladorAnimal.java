...
class TesteControladorAnimal {
    ...
    @Test
    void shouldAssociateAnimalWithEntidade() throws Exception {
        ...
        RequisicaoEntidade requisicao = new RequisicaoEntidade(
                ...
                "9-18",
                endereco);
        Entidade entidade = entidades.save(new Entidade(requisicao));

        mvc.perform(post("/api/v1/animais")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {"nome":"Rex","especie":"Cão","raca":"SRD","sexo":"Macho","idade":3,"peso":12.5,
                                 "descricao":"Dócil","status":"DISPONIVEL","idEntidade":%d}
                                """.formatted(entidade.getId())))
